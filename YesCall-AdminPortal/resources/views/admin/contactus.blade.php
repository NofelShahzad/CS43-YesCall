    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h1 class="page-title">Contact Us
                <small>Here you can see Contact Messages of the users.</small>
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            @if(Session::has('msg'))
                    ...
                    <table class="table dataTable">
                        ...
                        @foreach($data as $dt)
                            <tr>
                                ...
                                <td>{{ $dt->email }}</td>
                                <td> {{ $dt->msg }} SMS</td>
                                <td> {{ date("d,M,y H:s a",strtotime($dt->created_at)) }}</td>
                                </td>

                                <td><a class="btn btn-warning" href="{{ url('deletecontactus/'.$dt->id) }}">Delete</a>
                                </td>
