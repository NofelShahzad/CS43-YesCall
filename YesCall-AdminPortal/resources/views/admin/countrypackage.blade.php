                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <form action="{{ url('/submitcountrypackage') }}" method="post">
                                {{ csrf_field() }}

                                <div class="form-group">
                                    <label for="single" class="control-label">Select Country And Enter Calling  Amount $ per Minute </label>
                                   <input type="tel" id="phone" placeholder="Enter Amount" class="form-control">
                                </div>
                                <div class="pays">
                                    <div class="form-group">
                                        <label for="single" class="control-label">Cost per Sms $:</label>
                                        <input type="text" name="cost_per_sms" placeholder="Enter SMS Cost..." id="single" class="form-control">
